...
public class RadialGraphView extends Display {
    ...
    private String m_size = "edge_size";
    ...
    public RadialGraphView(Graph g, String label) {
        ...
        DataSizeAction edgeSize = new DataSizeAction("tree.nodes", "size");
        //edgeSize.setMaximumSize(10);
        ...
        ActionList myAction = new ActionList();
        ItemAction myEdgeSize = new DataSizeAction(treeEdges, m_size);
        myAction.add(myEdgeSize);
        m_vis.putAction("repaint", myAction);
