package edu.coeia.main.gui.util;
...
public class InfiniteProgressPanel extends JComponent implements MouseListener
{
    ...
    private Area[] buildTicker()
    {
        ...
        for (double i = 0.0; i < (double) barsCount; i++)
        {
            ...
            AffineTransform toCenter = AffineTransform.getTranslateInstance(480, 350);
            // 45 , -6 //
            AffineTransform toBorder = AffineTransform.getTranslateInstance(45.0, -6.0);
            AffineTransform toCircle = AffineTransform.getRotateInstance(-i * fixedAngle, 480, 350);
    ...
    private class Animator implements Runnable
    {
        ...
        public void run()
        {
            ...
            AffineTransform toCircle = AffineTransform.getRotateInstance(fixedIncrement, 480, 350);
